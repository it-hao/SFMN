...
parser.add_argument('--pre_train', type=str, default='./ckpt/sfmn_nh.pt', help="Path to pretrained model") 
parser.add_argument("--dataset", type=str, default='nh', help='indoor, outdoor, nh, dense, ohaze')
