...
from model.sfmn import Dehaze as Net
from data.test_data import TestData

parser = argparse.ArgumentParser(description="Testing for Dehazing Models")
parser.add_argument("--model", type=str, default='sfmn', help="Mode name") 
parser.add_argument('--pre_train', type=str, default='./ckpt/sfmn_ohaze.pt', help="Path to pretrained model") 
parser.add_argument("--dataset", type=str, default='ohaze', help='indoor, outdoor, nh, dense, ohaze')
...
if opt.dataset == 'indoor':
    test_data_dir = '/home/u2021171171/ITS/val_indoor'
    
elif opt.dataset == 'outdoor':
    test_data_dir = '/home/u2021171171/OTS/val_outdoor'
    
elif opt.dataset == 'dense':
    test_data_dir = '/home/u2021171171/Dense/val_dense'

elif opt.dataset == 'nh':
    test_data_dir = '/home/u2021171171/NH/val_nh'

elif opt.dataset == 'ohaze':
    test_data_dir = '/users/u2021171171/OHAZE/val_ohaze_full'
