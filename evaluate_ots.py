...
parser.add_argument('--pre_train', type=str, default='./ckpt/sfmn_ots.pt', help="Path to pretrained model") 
parser.add_argument("--dataset", type=str, default='outdoor', help='indoor, outdoor, nh, dense')
