...
class Trainer():
    ...
    def train(self):
        ...
        for batch, (hazy, gt, _, _) in enumerate(self.loader_train):
            ...
            # ================================================ loss ============================================
            # ==================================================================================================
            out_1, out_1_amp, out_1_phase, out_2, image_phase = self.model(hazy, 0)
            ...
            spa_loss = self.loss(out_1, gt_1) + self.loss(out_2, gt)

            fft_loss = (self.loss(out_1_amp, gt_amp) + self.loss(out_2_fft, label_fft)) * 0.05

            loss = spa_loss + fft_loss
            # ================================================loss ============================================
            # ==================================================================================================
