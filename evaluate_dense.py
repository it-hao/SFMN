...
parser.add_argument('--pre_train', type=str, default='./ckpt/sfmn_v2_dense.pt', help="Path to pretrained model") 
parser.add_argument("--dataset", type=str, default='dense', help='indoor, outdoor, nh, dense, ohaze')
...
if opt.dataset == 'indoor':
    ...
    test_data_dir = '/home/u2021171171/OHAZE/val_ohaze'
